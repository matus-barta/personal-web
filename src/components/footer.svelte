...
<footer class="w-full h-10 bg-neutral-700 text-slate-400 p-2 flex justify-center space-x-2">
    ...
    <a href="https://www.instagram.com/matus.barta09/">
        <img src="{ig}" alt=instagram on:mouseenter="{()=>{ig="/media/social/ig.svg"}}" on:mouseleave="{()=>{ig="/media/social/ig-grey.svg"}}"/>
    </a>
    <a href="https://www.youtube.com/channel/UCPWg-Iw7QFAXM-H2WjzPxiA">
        <img src="{yt}" alt=youtube on:mouseenter="{()=>{yt="/media/social/yt.svg"}}" on:mouseleave="{()=>{yt="/media/social/yt-grey.svg"}}"/>
    </a>
    <a href="https://github.com/matus-barta">
        <img src="{gh}" alt=github on:mouseenter="{()=>{gh="/media/social/gh.svg"}}" on:mouseleave="{()=>{gh="/media/social/gh-grey.svg"}}"/>
    </a>
</footer>
